...
![](/images/posts/2020-08-16-vrchat-removing-all-favorite-worlds/1.PNG)
</div>

:arrow_down: 思い出をあつめた写真立て♪

<div class="wrap-fluid">
![](/images/posts/2020-08-16-vrchat-removing-all-favorite-worlds/2.PNG)
</div>
...
```shell-session
$ hash=$(echo -n 'aiya000:vrchatPasswd000' | base64)
$ curl \
